...
U_NP,              U_NP,          U_LT(U_MEDIA, ESC), U_LT(U_NAV, TAB), U_LT(U_CODE, SPACE), U_LT(U_SYM, RET), U_LT(U_NUM, BSPC), U_LT(U_FUN, DEL), U_NP,            U_NP
...
&kp LALT   K10  K11  K12  K13  K14  	 K15  K16  K17  K18  K19  &kp  SQT   \
